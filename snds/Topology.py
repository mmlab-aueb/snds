...
class CustomTopology(Topo): 
    ...
    def create_local_topology_from_existing(self, topo: Topo):
        for node_name, params in topo.g.node.items():
            self.add_host(host_name=node_name, **params)
        
        for link_name, params in topo.g.edge.items():
            self.add_switch()
